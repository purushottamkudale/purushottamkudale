...
<meta name="description" content="Java Full-Stack Developer and SDE. Spring Boot, React, MySQL, Data Analytics. Projects, experience, tech stack, and contact details.">
...
.hero h2 { border: 0; margin: 0.9rem 0 0; padding: 0; font-size: clamp(1.1rem, 2.6vw, 1.4rem); font-weight: 600; color: var(--muted); }
...
<main class="wrap">
  ...
  <header class="hero" id="top">
    ...
    <div class="badges">
      <a class="badge lg" style="--c:#0A66C2" href="https://www.linkedin.com/in/purushottam-kudale/" target="_blank" rel="noopener">LinkedIn</a>
      <a class="badge lg" style="--c:#D93025" href="mailto:purushottamkudale0@gmail.com">Email</a>
      <a class="badge lg" style="--c:#181717" href="https://github.com/purushottamkudale" target="_blank" rel="noopener">GitHub</a>
  ...
  <section class="sec about" id="about">
    ...
    <ul class="emojilist">
      <li><span aria-hidden="true">🎓</span><span><strong>B.E. in Information Science & Engineering</strong> — SDM Institute of Technology, Ujire (CGPA 7.46)</span></li>
      ...
      <li><span aria-hidden="true">📊</span><span>Data analytics experience with <strong>Python, Pandas, NumPy, Excel, SQL, and Power BI</strong></span></li>
      ...
      <li><span aria-hidden="true">🐳</span><span>Currently strengthening my <strong>Linux, Docker & DevOps</strong> skills</span></li>
      <li><span aria-hidden="true">🔧</span><span>Comfortable with <strong>Git, GitHub, Maven, MySQL & MongoDB</strong></span></li>
      <li><span aria-hidden="true">🎯</span><span>Open to <strong>Java Full-Stack Developer / SDE opportunities</strong></span></li>
      <li><span aria-hidden="true">📍</span><span>Interested in opportunities in <strong>Bengaluru, Pune, Hyderabad & Remote</strong></span></li>
    </ul>
  </section>
  ...
  <section class="sec" id="stack">
    ...
    <h3 class="sub"><span aria-hidden="true">🚀</span> Tools & DevOps</h3>
    <div class="badges">
    ...
    <div class="badges">
      ...
      <span class="badge" style="--c:#D97757;--t:#000">Claude AI</span>
    </div>
  </section>
  ...
  <section class="sec" id="projects">
    ...
    <div class="chips" role="group" aria-label="Filter projects">
      ...
      <button type="button" class="chip" data-filter="data" aria-pressed="false">Data Analytics</button>
    ...
    <div class="grid">
      <article class="card wide" data-tags="java">
        ...
        <ul class="feat">
          ...
          <li><span aria-hidden="true">📧</span><span>Email notifications configurable via environment properties</span></li>
        </ul>
        <div class="badges">
        ...
        <div class="foot"><a class="badge lg" style="--c:#181717" href="https://github.com/purushottamkudale/Job-Portal-using-SpringBoot" target="_blank" rel="noopener">View project</a></div>
      </article>
      ...
      <article class="card" data-tags="java">
        ...
        <p class="desc">A college fest website rendered dynamically by Spring Boot with data served from MySQL database.</p>
        <ul class="feat">
          <li><span aria-hidden="true">🗓️</span><span>Schedules, speakers, FAQs, and gallery populated from database</span></li>
          <li><span aria-hidden="true">✅</span><span>Registration with Bean Validation and duplicate-email check</span></li>
          <li><span aria-hidden="true">🌱</span><span>Database automatically seeded with fest content on startup</span></li>
        </ul>
        <div class="badges">
          <span class="badge" style="--c:#ED8B00;--t:#000">Java 17</span>
        ...
        <div class="foot"><a class="badge lg" style="--c:#181717" href="https://github.com/purushottamkudale/Campus-Connect-using-SpringBoot" target="_blank" rel="noopener">View project</a></div>
      </article>
      ...
      <article class="card" data-tags="data">
        ...
        <p class="desc">In-depth exploratory data analysis and visual reporting on 10,000 synthetic order records.</p>
        <ul class="feat">
          <li><span aria-hidden="true">📈</span><span>Revenue trends, category and region performance, top customers</span></li>
          <li><span aria-hidden="true">🧮</span><span>Advanced SQL queries with window functions and MoM growth metrics</span></li>
          <li><span aria-hidden="true">🐍</span><span>Pandas data analysis pipeline and interactive Jupyter notebook</span></li>
          <li><span aria-hidden="true">📉</span><span>Interactive Power BI dashboard overview</span></li>
        </ul>
        <p class="note">The dataset is synthetic and tailored for analytical modeling.</p>
        <div class="badges">
          <span class="badge" style="--c:#3776AB">Python</span>
          <span class="badge" style="--c:#150458">Pandas</span>
          <span class="badge" style="--c:#4479A1">MySQL</span>
        ...
        <div class="foot"><a class="badge lg" style="--c:#181717" href="https://github.com/purushottamkudale/Ecommerce-Sales-Analytics" target="_blank" rel="noopener">View project</a></div>
      </article>
      ...
      <article class="card" data-tags="mern">
        ...
        <ul class="feat">
          <li><span aria-hidden="true">📅</span><span>Event scheduling & management</span></li>
          <li><span aria-hidden="true">🔔</span><span>Real-time notifications</span></li>
          <li><span aria-hidden="true">💬</span><span>Interactive discussion forums</span></li>
          <li><span aria-hidden="true">📊</span><span>Dynamic React dashboard with stats</span></li>
          <li><span aria-hidden="true">🔐</span><span>Secure user authentication & roles</span></li>
        </ul>
        <div class="badges">
          <span class="badge" style="--c:#47A248;--t:#000">MongoDB</span>
          <span class="badge" style="--c:#000000">Express.js</span>
        ...
        <div class="foot"><a class="badge lg" style="--c:#181717" href="https://github.com/purushottamkudale/Campus-Connect" target="_blank" rel="noopener">View project</a></div>
      </article>

      <article class="card" data-tags="php">
        <h3><span aria-hidden="true">🏋️</span> Gym Management System</h3>
        <p class="kind">PHP, MySQL, and Bootstrap</p>
        <p class="desc">A web-based system for managing gym operations, memberships, and payment flows.</p>
        <ul class="feat">
          <li><span aria-hidden="true">👤</span><span>Separate admin and member portals</span></li>
          <li><span aria-hidden="true">💳</span><span>Payment tracking & lifecycle management</span></li>
          <li><span aria-hidden="true">🗄️</span><span>Normalized relational MySQL database architecture</span></li>
          <li><span aria-hidden="true">🔐</span><span>Secure data handling and input sanitization</span></li>
        </ul>
        <div class="badges">
        ...
        <div class="foot"><a class="badge lg" style="--c:#181717" href="https://github.com/purushottamkudale/GYM-management-System" target="_blank" rel="noopener">View project</a></div>
      </article>
    </div>
  </section>
  ...
  <section class="sec" id="goals">
    ...
    <ul class="goals">
      <li><span aria-hidden="true">🚀</span><span>Build scalable, production-ready enterprise applications</span></li>
      <li><span aria-hidden="true">☕</span><span>Become an expert Java & Spring Boot Developer</span></li>
      <li><span aria-hidden="true">⚛️</span><span>Build modern, high-performance full-stack applications</span></li>
      <li><span aria-hidden="true">🐳</span><span>Master Docker, CI/CD pipelines, and DevOps principles</span></li>
      <li><span aria-hidden="true">☁️</span><span>Expand cloud architecture knowledge with AWS</span></li>
      <li><span aria-hidden="true">🤖</span><span>Integrate AI capabilities into modern software development</span></li>
    </ul>
  </section>
  ...
  <section class="sec connect" id="connect">
    ...
    <div class="badges">
      <a class="badge lg" style="--c:#0A66C2" href="https://www.linkedin.com/in/purushottam-kudale/" target="_blank" rel="noopener">LinkedIn: Purushottam Kudale</a>
      <a class="badge lg" style="--c:#181717" href="https://github.com/purushottamkudale" target="_blank" rel="noopener">GitHub: purushottamkudale</a>
    </div>
    <div class="copyrow">
...
(function () {
  ...
  var lines = [
    ...
    "Analyzing datasets with Python & SQL",
